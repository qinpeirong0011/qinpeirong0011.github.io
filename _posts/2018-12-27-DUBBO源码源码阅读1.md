...
# LoadBalance
 ...
 2、@Adaptive: 可以标记在SPI扩展类上，也可以标记在SPI接口的方法上。如果标记在扩展类上，SPI获取的实例是Adaptive+接口名称.class,如AdaptiveExtensionFactory、AdaptiveCompiler；如果标记在接口方法上，SPI对应的实例是动态代理类, 如接口名称+$Adpative.class
